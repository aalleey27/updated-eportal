...
<head>
    ...
    <link rel="stylesheet" href="/eportal/challan/challan.css">
    <title>Challan</title>
</head>
...
<body>
    ...
    <nav
        ...
        <div class="container flex flex-wrap items-center justify-between mx-auto">
            <a href="/newportal.html" class="flex items-center">
                <img src="/eportal/logo.png" class="h-6 mr-3 sm:h-9" alt="Flowbite Logo">
            ...
            <div class="flex md:order-2">
                ...
                <div class="text-left">
                    <!-- <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 m-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation">
    Show navigation
    </button> -->
                </div>
            </div>
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Classes</a>
                    </li>
                    <li>
                        <a href="#"
    ...
    <div class="downloadc">
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img class="rounded-t-lg" src="/eportal/challan/challan.png" alt="Chalan Pic" />
            </a>
            <div class="p-5">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Download Challan
                        for 5th Semester</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">The last date for challan submission is 1
                    feb. otherwise you will be fined 2000 per day.</p>
                <a href="/challan/challan (1).pdf"
                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    download="/challan/challan (1).pdf">
                    Download
        ...
        <form action="" method="post" enctype="">
            <div
                ...
                <path fill-rule="evenodd"
                    ...
                    clip-rule="evenodd"></path>
                <path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path></svg>
                <a href="#">
                    <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Upload Your
                        paid
                        Challan here</h5>
                </a>
                <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Your challan must be in pdf format
                    otherwise it
                    will rejected.</p>
